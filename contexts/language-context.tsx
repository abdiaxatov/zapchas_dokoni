...
const translations = {
  uzb: {
    ...
    // Loan/Debt translations
    "loan.title": "Qarzlar",
    "loan.addLoan": "Qarz berish",
    "loan.customerName": "Mijoz ismi",
    "loan.customerPhone": "Telefon raqami",
    "loan.customerAddress": "Manzil",
    "loan.totalAmount": "Umumiy summa",
    "loan.amountPaid": "To'langan summa",
    "loan.amountRemaining": "Qolgan qarz",
    "loan.loanDate": "Qarz berilgan sana",
    "loan.dueDate": "To'lov muddati",
    "loan.status": "Holati",
    "loan.status.pending": "To'lanmagan",
    "loan.status.partial": "Qisman to'langan",
    "loan.status.paid": "To'langan",
    "loan.addPayment": "To'lov qo'shish",
    "loan.paymentAmount": "To'lov summasi",
    "loan.paymentNote": "Izoh",
    "loan.paymentHistory": "To'lovlar tarixi",
    "loan.notes": "Eslatmalar",
    "loan.sellAsLoan": "Qarzga sotish",
    "loan.sellAsCash": "Naqd sotish",
    "loan.loanList": "Qarzga olganlar ro'yxati",
    "loan.totalLoans": "Jami qarzlar",
    "loan.pendingLoans": "To'lanmagan qarzlar",
    "loan.paidLoans": "To'langan qarzlar",
    "loan.viewDetails": "Tafsilotlar",
    "loan.makePayment": "To'lov qilish",
    "loan.paymentSuccess": "To'lov muvaffaqiyatli qo'shildi",
    "loan.loanCreated": "Qarz muvaffaqiyatli yaratildi",
    "loan.receiptNumber": "Chek raqami",
  ...
  kares: {
    ...
    "loan.title": "대출",
    "loan.addLoan": "대출 추가",
    "loan.customerName": "고객 이름",
    "loan.customerPhone": "전화번호",
    "loan.customerAddress": "주소",
    "loan.totalAmount": "총 금액",
    "loan.amountPaid": "지불된 금액",
    "loan.amountRemaining": "남은 금액",
    "loan.loanDate": "대출 날짜",
    "loan.dueDate": "만기일",
    "loan.status": "상태",
    "loan.status.pending": "미지급",
    "loan.status.partial": "부분 지급",
    "loan.status.paid": "지급 완료",
    "loan.addPayment": "지불 추가",
    "loan.paymentAmount": "지불 금액",
    "loan.paymentNote": "메모",
    "loan.paymentHistory": "지불 내역",
    "loan.notes": "메모",
    "loan.sellAsLoan": "대출로 판매",
    "loan.sellAsCash": "현금 판매",
    "loan.loanList": "대출자 목록",
    "loan.totalLoans": "총 대출",
    "loan.pendingLoans": "미지급 대출",
    "loan.paidLoans": "지급된 대출",
    "loan.viewDetails": "세부정보",
    "loan.makePayment": "지불하기",
    "loan.paymentSuccess": "지불이 성공적으로 추가되었습니다",
    "loan.loanCreated": "대출이 성공적으로 생성되었습니다",
    "loan.receiptNumber": "영수증 번호",
    "loan.noLoans": "대출 없음",
